...
// Exemplo com jogos e DLCs

// Interface do jogo - Molde
interface JogoProp {
    readonly id: string;
    nome: string;
    descricao: string;
...
// A dlc agora tem tudo que a interface 'JogoProp' tem a mais do que ela já tem
interface DLC extends JogoProp {
    novoConteudo: string[];
    jogoOriginal: JogoProp // aqui ele quer um objeto com o mesmo formato dessa interface.
}
