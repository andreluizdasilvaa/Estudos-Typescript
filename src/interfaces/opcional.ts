...
const usuarioNovo: CadastroProps = {
    nome: "André",
...
const usuarioNovo2: CadastroProps = {
    email: "andre@teste.com",
    status: true
}
...
// Com descontrução
function handleRegister({ nome, email, status}: CadastroProps): object {
    const data = {
        nome,
        email,
        status
...
// Sem descontrução 
function handleLogin(props: CadastroProps): void {
